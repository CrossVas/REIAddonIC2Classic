...
public class RumBrewDisplay extends BasicDisplay {

    private RumBrewRecipe RECIPE;

    public RumBrewDisplay(RumBrewRecipe recipe) {
    ...
    public RumBrewDisplay(List<EntryIngredient> inputs, List<EntryIngredient> outputs) {
    ...
    public RumBrewRecipe getRecipe() {
        return this.RECIPE;
    }
}
